        ...
        it('should write to file correct base64 string', function () {
            ...
            outputter.output(function () {
                fs.readFile(outputter.path, 'utf8', function (err, data) {
                    ...
                    assert.equal(spritesObject.main[1][1], 'data:image/gif;base\
                    64,R0lGODlhEAAQAPcAAMgAyPgA+AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\
                    ...
                    AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\
                    AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\
                    AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACH5BAEAAAIALAAAAAA\
                    QABAAh8gAyPgA+AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\
                    AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\
                    AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\
                    AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\
                    AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\
                    ...
                    AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\
                    AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\
                    AAAAAAAAAAAAAAAAAAAAAAAAAAAAg9AAMIHEiwIICCCAkeHAhgIcOFDhMaT\
                    BiRIcWLCBtWrKhwosSNFgVq9BigoUSRHUOqFKkR5EmSL1m2nEkzIAA7');
                });
            });
        });
